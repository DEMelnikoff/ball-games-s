...
var slingshot2 = (function () {
    ...
    var	firing = false;		 // flag whether the slingshot2 was fired
    ...
    game.run = function(c, trial, mmPerPx) {
        ...
        var goalMssg1 = set.frame.streak ? "Your goal is to maximize the length of your average hit streak." : "Your goal is to minimize your average distance from the target.";

        var goalMssg2 = set.frame.streak ? "Try to hit the target as many times in a row as possible." : "Try to shoot the ball as close to the target as possible.";

        var moneyMssg = set.frame.money ? "The top 10 performers will each receive $20! Good luck!" : "Good luck!";

        let gameName = (set.frame.streak) ? 'Streak-o-Rama' : 'Close Call';
        ...
        function text(canvas, options, c) {
            ...
            const drawInstructionalMessages = () => {
                ...
                if (game.data.totalTrials === 0 && intro <= 2) {
                    ...
                    drawText("16px Arial", "white", "Step 2: Aim at the red circle,", canvas.width / 2, 160, 'center');
